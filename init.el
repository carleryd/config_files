...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (prism rainbow-mode yaml-mode web-mode use-package tide solidity-mode purescript-mode psc-ide prettier-js php-mode nix-mode neotree moe-theme js3-mode indium helm-projectile helm-ag haskell-mode go-mode gnugo exec-path-from-shell evil-surround evil-numbers evil-magit evil-leader evil-escape evil-commentary elm-mode editorconfig centered-window alchemist ag add-node-modules-path))))
